...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/uws: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/uws ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/sys/clock.o: sys/clock.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys/clock.o sys/clock.cpp

${OBJECTDIR}/sys/epoll.o: sys/epoll.cpp
	${MKDIR} -p ${OBJECTDIR}/sys
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys/epoll.o sys/epoll.cpp

${OBJECTDIR}/sys/poller_base.o: sys/poller_base.cpp
	${MKDIR} -p ${OBJECTDIR}/sys
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys/poller_base.o sys/poller_base.cpp

${OBJECTDIR}/sys/signaler.o: sys/signaler.cpp
	${MKDIR} -p ${OBJECTDIR}/sys
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys/signaler.o sys/signaler.cpp

${OBJECTDIR}/sys/thread.o: sys/thread.cpp
	${MKDIR} -p ${OBJECTDIR}/sys
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys/thread.o sys/thread.cpp
